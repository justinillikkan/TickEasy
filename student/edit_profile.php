...
//echo $name;
//echo $id;
$sql="select * from student_tb,user_tb,login_tb,staff_tb where login_tb.user_id='$id' and user_tb.user_id='$id' and login_tb.user_id=user_tb.user_id";
...
if(isset($_POST['submit']))
{
	...
	echo "<script>if(confirm('Updated Successfully!!!!')){document.location.href='edit_profile_sample.php'}else{document.location.href='edit_profile_sample.php'};</script>";
  ...
  <div class="row">
        ...
        <form class="f" height="auto" width="auto" action="#" method="POST" name="my_form" enctype='multipart/form-data'  enctype='multipart/form-data'>
		   ...
		   <div class="col-md-2 offset-1 padd">
			...
			<div class="col-md-3 padd">
		   <input  type="textarea" maxlength="10" name="phone" id="mobno" class=" form-control" 
		...
		<div class="col-md-4  offset-6 padd">
