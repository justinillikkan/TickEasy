...
<ul>
  <li><a class="active" href="http://localhost/AMS-2/index.php">HOME</a></li>
  <tr><li><a href="http://localhost/AMS/stafflogin.php">STAFF PORTAL</a></li></tr>
  <tr><li><a href="http://localhost/AMS/studentlogin.php">STUDENT PORTAL</a></li></tr>
</ul>
    ...
    <div class="container">
        ...
        <form action="#" method="POST">
            ...
            <div class="input-inform">
                <input type="text" name="uname" id="name" placeholder="LOGIN..." />
                <input type="password" name="psw" id="password" placeholder="PASSWORD..." />
                <input type="button" value="FORGOT PASSWORD?" id="forgot-pas"/>
            </div>
            <div class="enter">
 <button type="submit" name="submit" style="width:70px;height:50px;backgrond-color:white;color:blue;"><b>Login</button><br><br>
            </div>
        </form>    
    </div>
</div>
