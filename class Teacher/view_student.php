...
<body>
       ...
       <!-- <div class="container">
		...
		<form name="myform" action="view_student_sample.php" method="post">
 ...
 <div id="divToPrint" >
  <div class="limiter">
						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th class="cell100 column4">Dob</th>
									<th class="cell100 column5">Guard Name</th>
									<th class="cell100 column6">Phone</th>
									<th class="cell100 column7">approve</th>
				...
				//echo $bid;
					...
					$sql1="SELECT * FROM student_tb,user_tb where user_tb.user_type='student' and student_tb.batch_id='$bid' and student_tb.user_id=user_tb.user_id and user_tb.status='0'";
          ...
          while($row=mysqli_fetch_array($result1)){
				?>
									...
									<td style="text-align:center;"class="cell100 column4"><?php echo $row['dob'];  ?></td>
									<td style="text-align:center;" class="cell100 column5"><?php echo $row['stud_guard_name'];  ?></td>
									<td style="text-align:center;"class="cell100 column6"><?php echo $row['phone'];  ?></td>
									<td style="text-align:center;" class="cell100 column7"><?php
						if($row['status']==1){
					?>
                    <a href="approve_student.php?id=<?php echo $row['user_id']; ?>&status=0">Dissaprove</a>
                    <?php
					} else{
					?>

                    <a href="approve_student.php?id=<?php echo $row['user_id']; ?>&status=1">Approve</a>
                    <?php
					}
					?></td>
					<td><a href="delete_student.php?id=<?php echo $row['user_id']; ?>">Delete</a></td>
									<td style="text-align:center;" class="cell100 column8"><a href="delete_staff.php?id=<?php echo $row['user_id']; ?>"></td>
									</tr>
