...
if(isset($_POST['submit']))
{
	...
	echo "<script>if(confirm('Upadeted Successfully!!!!')){document.location.href='edit_profile.php'}else{document.location.href='editProfile.php'};</script>";
...
<body>
       ...
       <!-- <div class="container">
		...
		<form name="myform" action="edit_Profile_sample.php" method="post">
