...
<body>
	...
	<form name="myform" action="add_attendance_sample.php" method="post">
...
if(isset($_POST["submit"]))
{
	...
	echo "<script>if(confirm('Upadeted Successfully!!!!')){document.location.href='attendance.php'}else{document.location.href='editProfile.php'};</script>";
}
}
?>
