...
<body>
       ...
       <!-- <div class="container">
		...
		<form name="myform" action="view_student_test.php" method="post">
...
<!--                    <li><a href="group_reg.php"><h2>Group registration<h2></a></li>-->
			...
			<td><div class="col-md-2 offset-7 padd">
		  <h2> Course</h2>
...
?>
									...
									<td style="text-align:center;"class="cell100 column2"><?php echo $row['phone']?></td>
