...
<ul class="nav nav-tabs" style="margin-top: 35px;">
   ...
   <a href="add_subject.php">Subject</a> 
	...
	<li><a href="logout.php">LOGOUT</a></li>
			...
			<td><div class="col-md-2 offset-4 padd">
		  <h2> Course</h2>
		 ...
		 <br> <br> <br>
			   ...
			   <div class="col-md-2 offset-4 padd">
		  <h2> Batch</h2> 
		 </div> 
		 ...
		 <div class="col-md-3 padd">
			 ...
			 <div class="col-md-2  offset-5 padd">
		  <input type ="submit" name="submit1" id="submit" value="VIEW" style="margin-top:25px;" class="btn btn-lg btn-success btn-block"/>
		  </div>
