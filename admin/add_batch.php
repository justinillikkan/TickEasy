...
<ul class="nav nav-tabs" style="margin-top: 35px;">
   ...
   <a href="add_subject.php">Subject</a> 
	...
	<li><a href="logout.php">LOGOUT</a></li>
        ...
        <form class="f" height="auto" width="auto" action="#" method="POST" name="my_form" enctype='multipart/form-data'  enctype='multipart/form-data'>
		  ...
		  <h2> Course</h2>
			...
			<select class=" form-control" id="district_select" name="ddlcourse" required >
	...
	?>
		 ...
		 <div class="col-md-3 padd">
                 <input  type="text"  name="batch" id="no_members" class=" form-control"  required />
			</div>
...
if(isset($_POST["submit"]))
{
	...
	//echo $q;
	//echo $a;
	$sql2="select * from `batch_tb`  where  `batch_name`='$a'";
...
echo '<script>alert("ALREADY added");</script>';
	...
	$sql="INSERT INTO `batch_tb`(`course_id`,`batch_name`) VALUES ('$q','$a')";
