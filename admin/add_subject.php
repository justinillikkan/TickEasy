   ...
   <a href="add_subject.php">Subject</a> 
	...
	<li><a href="logout.php">LOGOUT</a></li>
        ...
        <form class="f" height="auto" width="auto" action="#" method="POST" name="my_form" enctype='multipart/form-data'  enctype='multipart/form-data'>
		 ...
		 <div class="col-md-3 padd">
                 <input  type="text"  name="sub" id="no_members" class=" form-control"  required />
			</div>
			
		 
		  <div class="col-md-3  offset-9 padd">
...
if(isset($_POST["submit"]))
{
	...
	$sql2="select * from subject_tb  where `subject_name`='$d' and `batch_id`='$a'";
	...
	$sql="INSERT INTO `subject_tb`(`subject_name`, `course_id`, `batch_id`) VALUES ('$d','$q','$a')";
	$result=mysqli_query($con,$sql);
	echo "<script>alert(' Successfully Added');window.location.href = 'add_subject.php';</script>";
