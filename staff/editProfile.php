...
if(isset($_POST['submit']))
{
	...
	echo "<script>if(confirm('Upadeted Successfully!!!!')){document.location.href='editProfile_sample.php'}else{document.location.href='editProfile.php'};</script>";
...
<br> <br>
 <div class="row">
		...
		<div class="col-md-3  offset-5 padd">
