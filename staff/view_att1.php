...
<div class="col-md-5 offset-4">
	<div class="row">
		...
		<div class="col-md-4 offset-1">
			<select name="course_name" id="course_name" style="width:70%; height:30px;" required>
		...
		<div class="col-md-4 offset-1" id="rose">
				<select name="des" style="width:70%; height:30px;" value="Batch"  required>
				 <option value="-1">select</option>
				  <?php
				  $id=$_SESSION['id'];
				  echo $id;
				  ...
				  {
                   ?>
					<option style="width:150px;height:150px;"value=<?php echo $row['subject_id'];?>><?php echo $row['subject_name'];?></option>
...
{
	$_SESSION['course'] = $_POST["course_name"];
	$_SESSION['bat_id']= $_POST["batch"];
	$_SESSION['subject']=$_POST["des"];
	//$_SESSION["Hr"]= $_POST["hr"];
	//$_SESSION['dob']=$_POST["dob"];
	//echo "window.location.href="view_attendance.php"";
	//header("location:view_attendance.php");
			echo "<script>window.location.href = 'view_attendance.php';</script>";
