...
$sql2="select * from attendance_tb where `course_id`='$co' and `batch_id`='$ba' and `date`='$date' and  `hour`='$hr' ";
    ...
    echo '<script>alert("ALREADY ADDDED");</script>';
			//echo "<script>if(confirm('already Added!!! Do You Want To Add Another?')){document.location.href='add_attendance.php'}else{document.location.href='attendance.php'};</script>";
